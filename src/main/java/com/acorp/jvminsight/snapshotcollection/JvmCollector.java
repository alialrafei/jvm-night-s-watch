            ...
            try {
                JvmSnapshot snapshot = new JvmSnapshot(
                    ...
                    for (GcSnapshot gc : gcs) {
                        System.out.printf("%-25s count=%d time=%dms%n", gc.name, gc.collectionCount, gc.collectionTimeMillis);
                    }
                    ...
                    String histogram = "";
                    try {
                        histogram = (String) mbeanServer.invoke(dcmd, "gcClassHistogram", new Object[]{arggumentStrings}, new String[]{"[Ljava.lang.String;"});
                    ...
                    snapshot.setHistogram(histogram);
